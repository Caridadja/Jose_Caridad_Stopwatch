<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import = "com.caridadja.web.models.Timer" %>
...
<% cal2.setTime((Date)request.getSession().getAttribute("currTime")); %>
<% if(request.getSession().getAttribute("startTime") != null){ %>
	...
	<p>Total Time: <%=TimeUnit.MILLISECONDS.toSeconds(Timer.getDifference((Date)request.getSession().getAttribute("currTime"), (Date) request.getSession().getAttribute("startTime"))) %></p>
